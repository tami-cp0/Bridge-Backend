...
export class SchedulerService {
  ...
  // Runs at midnight — ensures ratings reflect the latest sweep and CAC data each day
  ...
  // Runs at 1 AM — marks listings as defaulted if they haven't repaid within MAX_DEAL_DURATION_MONTHS
  ...
  // Runs at 2 AM — refreshes the single-row platformStats aggregate for the public stats endpoint
