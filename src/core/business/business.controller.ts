...
export class BusinessController {
  ...
  @ApiQuery({ name: 'month', required: false, type: Number, description: 'Required for daily period (1â€“12)', example: 5 })
  @ApiOperation({ summary: 'Get incoming revenue aggregated by day, month, or year â€” excludes manual full-repayment events' })
  @ApiResponse({
    status: 200,
    schema: {
      type: 'object',
