...
export class BridgeRatingService {
  ...
  // Max 30 pts — compares actual swept amount to what was expected by this point in time
  ...
  // Max 25 pts — deducts 3 pts for each payment gap longer than 14 days
  ...
  // Max 20 pts — compares last 30 days' incoming payments to the business's Mono baseline
  ...
  // Max 15 pts — uses coefficient of variation across weekly buckets over the last 60 days
  ...
  // Max 5 pts — penalises long gaps between payments (same logic as consistency but smaller weight)
